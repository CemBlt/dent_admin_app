...
def log_event(
    ...
    *,
    ...
    Args:
        event_name: Descriptive event title (e.g. ``panel_login_success``).
        request: Optional Django request to pull session user/hospital ids from.
        user_id: Explicit user id override.
        hospital_id: Explicit hospital id override.
        properties: Additional JSON-serialisable payload.
    """
